...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "mpc_at_localhost";
		$data["connName"] = "mpc at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;mpc;;1"; //currently unused

		$this->_connectionsIdByName["mpc at localhost"] = "mpc_at_localhost";
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=mpc;OPTION=3";
		// encription set
		...
		$connectionsData["mpc_at_localhost"] = $data;
