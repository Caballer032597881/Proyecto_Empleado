...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "emp_deduciones" ] = array( "url" => "emp_deduciones", "type" => 0 );
	$projectEntitiesReverse[ "emp_deduciones" ] = "emp_deduciones";
	$projectEntities[ "emp_tipoemp" ] = array( "url" => "emp_tipoemp", "type" => 0 );
	$projectEntitiesReverse[ "emp_tipoemp" ] = "emp_tipoemp";
	$projectEntities[ "emp_mstemp" ] = array( "url" => "emp_mstemp", "type" => 0 );
	$projectEntitiesReverse[ "emp_mstemp" ] = "emp_mstemp";
}
