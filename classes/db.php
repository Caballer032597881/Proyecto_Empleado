...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "emp_deduciones", "varname" => "mpc_at_localhost__emp_deduciones", "altvarname" => "emp_deduciones", "connId" => "mpc_at_localhost", "schema" => "", "connName" => "mpc at localhost");
			$dalTables[$conn->connId][] = array("name" => "emp_mstemp", "varname" => "mpc_at_localhost__emp_mstemp", "altvarname" => "emp_mstemp", "connId" => "mpc_at_localhost", "schema" => "", "connName" => "mpc at localhost");
			$dalTables[$conn->connId][] = array("name" => "emp_tipoemp", "varname" => "mpc_at_localhost__emp_tipoemp", "altvarname" => "emp_tipoemp", "connId" => "mpc_at_localhost", "schema" => "", "connName" => "mpc at localhost");
		}
	}
