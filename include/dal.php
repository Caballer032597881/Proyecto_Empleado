...
class tDAL
{
	var $tblmpc_at_localhost__emp_deduciones;
	var $tblmpc_at_localhost__emp_mstemp;
	var $tblmpc_at_localhost__emp_tipoemp;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "emp_deduciones", "varname" => "mpc_at_localhost__emp_deduciones", "altvarname" => "emp_deduciones", "connId" => "mpc_at_localhost", "schema" => "", "connName" => "mpc at localhost");
		$this->lstTables[] = array("name" => "emp_mstemp", "varname" => "mpc_at_localhost__emp_mstemp", "altvarname" => "emp_mstemp", "connId" => "mpc_at_localhost", "schema" => "", "connName" => "mpc at localhost");
		$this->lstTables[] = array("name" => "emp_tipoemp", "varname" => "mpc_at_localhost__emp_tipoemp", "altvarname" => "emp_tipoemp", "connId" => "mpc_at_localhost", "schema" => "", "connName" => "mpc at localhost");
	}
